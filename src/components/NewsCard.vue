<template>
    ...
    <div class="col-md-12 col-sm-9 col-11 m-0 d-flex flex-column justify-content-start">
    ...
    <div class="container col-md-12 col-sm-11 col-12"> 
        <div v-for="data in news.slice(0, limit)" :key="data.id" class="ms-0 row mt-3 box-news">
            ...
            <div class="d-flex justify-content-end pt-3">
                <button v-if="limit < 10" class="btn btn-primary" @click="moreNews()">More News</button>
