...
export default {
  ...
  methods : {
      getNews(){
          axios.get('https://newsapi.org/v2/everything?qlnTitle=' + this.data.qlnTitle + '&q='+ this.data.q +'&language=' + this.data.language + '&sortBy=' + this.data.sortBy +'&apiKey=6c0c839f2c914a1ea4fbef97585da424').then((res)=>{
